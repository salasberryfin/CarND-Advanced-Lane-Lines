...
if __name__ == "__main__":
    ...
    undistorted_straight = img_operation.undistort_images(straight_list)
    undistorted = undistorted_imgs + undistorted_straight
    for frame in undistorted:
        ...
        # cv2.imwrite("output_images/new_undist/final_results/lane-detection-{}.jpg".format(name), text_image)
